classdef rpPathDepend < RandProcess
%rpPathDepend prescribed likelyhood for staying on a current path
%
% Random process with user assigned likelyhood of staying at the same value
% (or corresponding value for t+1) with remaining probability symetrically divided among
% other values.
%

function [next_pre_state_list] = ...
    InvRandomApply(params, t, post_state_list, uncertain_demand_list) %#ok<INUSL>
% INVRANDOMAPPLY Applies the provided uncertainty(ies) to the current (post-decision) state 
% 
...
% ---  ---------- -----  ----------- ---------------------------------------
%   1  2016-10-27 13:31  BryanP      Initial Code adapted from InvDecisionApply v7 

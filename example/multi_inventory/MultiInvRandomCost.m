function c_list = MultiInvRandomCost(params, t, post_state_list, uncertain_demand_list) %#ok<INUSL>
% MULTIINVRANDOMCOST DP uncertainty cost for multi-product inventory problem
%
% Usage: c_list = MultiInvRandomCost(params, t, post_state_list, uncertain_demand_list)
%
...
%   1  2016-10-27 12:31  BryanP      adapted from MultiInvDecisionApply v9
